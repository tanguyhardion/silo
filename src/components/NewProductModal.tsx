...
export function NewProductModal({ isOpen, onClose, onSuccess }: NewProductModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-xs animate-in fade-in">
      <div className="relative w-full max-w-xl max-h-[90vh] flex flex-col rounded-3xl bg-[#FCFBF8] shadow-2xl border border-[#DFD9CC] overflow-hidden">
        {/* Header */}
        ...
        {/* Scrollable Form Body with margin to prevent scrollbar from bleeding into rounded corners */}
